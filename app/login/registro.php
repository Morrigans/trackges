...
<p><strong>NOMBRE:            
<input name="dni" placeholder="NOMBRE" type = "text"/>
</strong></p>
...
if ($stmt = $conn->prepare("INSERT INTO login (NOMBRE, USUARIO, PASS) VALUES (?, ?, ?)"))
{
          $dni = $_POST['dni'];
      ...
      $stmt->bind_param("sss", $dni, $usuario, $hashPassword);
	    $stmt->execute();
