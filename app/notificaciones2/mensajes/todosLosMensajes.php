...
FROM $MM_oirs_DATABASE.notificaciones 

LEFT JOIN derivaciones
ON notificaciones.ID_DERIVACION = derivaciones.ID_DERIVACION

LEFT JOIN pacientes
ON derivaciones.ID_PACIENTE= pacientes.ID

where notificaciones.USUARIO='$usuario' order by notificaciones.ID DESC
