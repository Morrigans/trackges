...
<script>
  $('#dvMenuDashboardFinanciero').load('vistas/menuLateral/menuDashboardFinanciero.php');
  $('#dvMenuDashboardComercial').load('vistas/menuLateral/menuDashboardComercial.php');
  $('#dvMenuDashboardOperacional').load('vistas/menuLateral/menuDashboardOperacional.php');
