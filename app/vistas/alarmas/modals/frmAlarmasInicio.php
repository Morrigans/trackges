		...
		$.ajax({
			...
			success:function(r){
				if (r == 1) {
					...
					setTimeout(function (){ $('#dvFrmAlarmasInicio').load('vistas/alarmas/modals/frmAlarmasInicio.php'); $("#menuSuperior").load('notificaciones/navbar.php'); }, 1500);//retardo PARA EVITAR dropdown
	    	}
			}
		});
	}
		...
		$.ajax({
			...
			success:function(r){
				if (r == 1) {
					...
					setTimeout(function (){ $('#dvFrmAlarmasInicio').load('vistas/alarmas/modals/frmAlarmasInicio.php'); }, 1);//retardo PARA EVITAR dropdown
	    	}
			}
		});
	}
