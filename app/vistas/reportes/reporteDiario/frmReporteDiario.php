...
if (fecha=='') {
$('#dvMuestraTblReporteDiario').load('vistas/reportes/reporteDiario/tblReporteDiario.php?fecha='+hoy);

}

  function fnReporteDiario(fecha){

    $('#dvMuestraTblReporteDiario').load('vistas/reportes/reporteDiario/tblReporteDiario.php?fecha='+fecha);
