	...
	if (filtro == 'Alta Paciente') {
		$(function () {
		    $('#tPacientesDerivadosTens').DataTable({
		      ...
		      "stateSave": true,
		      "ajax": {
		                 "url": "vistas/serverProcessing/tens/altaPaciente.php",
		                 data: function (d) {
		                     d.idUsuario = $('#idUsuario').val();//paso el id del usuario para filtrar por sesion en el serverSide de datatable
		                 },
		             },
	...
	if (filtro == 'Autorizado para pago') {
		$(function () {
		    $('#tPacientesDerivadosTens').DataTable({
		      ...
		      "stateSave": true,
		      "ajax": {
		                 "url": "vistas/serverProcessing/tens/autorizadoPago.php",
		                 data: function (d) {
		                     d.idUsuario = $('#idUsuario').val();//paso el id del usuario para filtrar por sesion en el serverSide de datatable
		                 },
		             },
	...
	if (filtro == 'Validado para Pago') {
		$(function () {
		    $('#tPacientesDerivadosTens').DataTable({
		      ...
		      "stateSave": true,
		      "ajax": {
		                 "url": "vistas/serverProcessing/tens/validadoPago.php",
		                 data: function (d) {
		                     d.idUsuario = $('#idUsuario').val();//paso el id del usuario para filtrar por sesion en el serverSide de datatable
		                 },
		             },
	...
	if (filtro == 'prestador_asignado') {
		$(function () {
		    $('#tPacientesDerivadosTens').DataTable({
		      ...
		      "lengthMenu": [[10, 50, -1], [10, 50, "Todos"]],
		      "ajax": {
		                 "url": "vistas/serverProcessing/tens/prestadorAsignado.php",
		                 data: function (d) {
		                     d.idUsuario = $('#idUsuario').val();//paso el id del usuario para filtrar por sesion en el serverSide de datatable
		                 },
		             },
	...
	if (filtro == 'mis_casos') {
		$(function () {
		    $('#tPacientesDerivadosTens').DataTable({
		      ...
		      "lengthMenu": [[10, 50, -1], [10, 50, "Todos"]],
		      "ajax": {
		                 "url": "vistas/serverProcessing/tens/misCasos.php",
		                 data: function (d) {
		                     d.idUsuario = $('#idUsuario').val();//paso el id del usuario para filtrar por sesion en el serverSide de datatable
		                 },
		             },
