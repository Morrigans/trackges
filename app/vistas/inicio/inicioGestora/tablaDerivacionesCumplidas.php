					...
					<div class="btn-group">
						...
						<div class="dropdown-menu" role="menu">
							<?php if ($qrDerivacion->Fields('ESTADO') == 'pendiente' and $qrDerivacion->Fields('REASIGNADA') == 'no') {
								...
								<a class="dropdown-item" href="#" data-toggle="modal" data-target="#modalAceptarCasoGestora" onclick="fnfrmAceptarCaso('<?php echo $qrDerivacion->Fields('ID_DERIVACION') ?>')">Aceptar Caso</a>
								<a class="dropdown-item" href="#" data-toggle="modal" data-target="#modalReasignarCasoGestora" onclick="fnfrmReasignarCaso('<?php echo $qrDerivacion->Fields('ID_DERIVACION') ?>')">Reasignar Caso</a>
								<a class="dropdown-item" href="#" data-toggle="modal" data-target="#modalCerrarCasoGestora" onclick="fnfrmCerrarCaso('<?php echo $qrDerivacion->Fields('ID_DERIVACION') ?>')">Cerrar Caso</a>
							...
							if ($qrDerivacion->Fields('ESTADO') == 'aceptada' and $qrDerivacion->Fields('REASIGNADA') == 'no') { //no reasignada
								...
								?>
								<a class="dropdown-item" href="#" data-toggle="modal" data-target="#modalAsignarPrestadorCasoGestora" onclick="fnfrmAsignarPrestadorCaso('<?php echo $qrDerivacion->Fields('ID_DERIVACION') ?>')">Asignar prestador</a>
								<a class="dropdown-item" href="#" data-toggle="modal" data-target="#modalReasignarCasoGestora" onclick="fnfrmReasignarCaso('<?php echo $qrDerivacion->Fields('ID_DERIVACION') ?>')">Reasignar Caso</a>
								<a class="dropdown-item" href="#" data-toggle="modal" data-target="#modalCerrarCasoGestora" onclick="fnfrmCerrarCaso('<?php echo $qrDerivacion->Fields('ID_DERIVACION') ?>')">Cerrar Caso</a>
