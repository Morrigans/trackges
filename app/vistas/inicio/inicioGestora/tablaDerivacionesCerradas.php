...
<script type="text/javascript">
	...
	function fnfrmInformacionPacienteGestora(idDerivacion){
	    $('#dvFrmInformacionPacienteGestora').load('vistas/inicio/inicioSupervisora/modals/informacionPaciente/frmInformacionPaciente.php?idDerivacion=' + idDerivacion);
	}
</script>