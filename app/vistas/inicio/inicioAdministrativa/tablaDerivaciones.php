...
<table id="tPacientesDerivadosAdministrativa" class="table table-bordered table-striped table-hover table-sm">
...
<script type="text/javascript">
	...
	if (filtro == 'todo') {
		$(function () {
		    $('#tPacientesDerivadosAdministrativa').DataTable({
		      "paging": true,
		      "lengthChange": true,
		      "searching": true,
		      "ordering": true,
		      ...
		      "ajax": {
		                 "url": "vistas/serverProcessing/administrativa/derivaciones.php",
		                 data: function (d) {
	...
	if (filtro == 'pendiente') {
		$(function () {
		    $('#tPacientesDerivadosAdministrativa').DataTable({
		      ...
		      "stateSave": true,
		      "ajax": {
		                 "url": "vistas/serverProcessing/administrativa/pendientes.php",
		                 data: function (d) {
		                     d.idUsuario = $('#idUsuario').val();//paso el id del usuario para filtrar por sesion en el serverSide de datatable
		                 },
		             },
	...
	if (filtro == 'aceptada') {
		$(function () {
		    $('#tPacientesDerivadosAdministrativa').DataTable({
		      ...
		      "stateSave": true,
		      "ajax": {
		                 "url": "vistas/serverProcessing/administrativa/aceptadas.php",
		                 data: function (d) {
		                     d.idUsuario = $('#idUsuario').val();//paso el id del usuario para filtrar por sesion en el serverSide de datatable
		                 },
		             },
	...
	if (filtro == 'porVencer') {
		$(function () {
		    $('#tPacientesDerivadosAdministrativa').DataTable({
		      ...
		      "stateSave": true,
		      "ajax": {
		                 "url": "vistas/serverProcessing/administrativa/por_vencer.php",
		                 data: function (d) {
		                     d.idUsuario = $('#idUsuario').val();//paso el id del usuario para filtrar por sesion en el serverSide de datatable
		                 },
		             },
	...
	if (filtro == 'vencidas') {
		$(function () {
		    $('#tPacientesDerivadosAdministrativa').DataTable({
		      ...
		      "stateSave": true,
		      "ajax": {
		                 "url": "vistas/serverProcessing/administrativa/vencidas.php",
		                 data: function (d) {
		                     d.idUsuario = $('#idUsuario').val();//paso el id del usuario para filtrar por sesion en el serverSide de datatable
		                 },
		             },
	...
	if (filtro == 'cumplidas') {
		$(function () {
		    $('#tPacientesDerivadosAdministrativa').DataTable({
		      ...
		      "stateSave": true,
		      "ajax": {
		                 "url": "vistas/serverProcessing/administrativa/cumplidas.php",
		                 data: function (d) {
		                     d.idUsuario = $('#idUsuario').val();//paso el id del usuario para filtrar por sesion en el serverSide de datatable
		                 },
		             },
	...
	if (filtro == 'mas24HrsSinAgenda') {
		$(function () {
		    $('#tPacientesDerivadosAdministrativa').DataTable({
		      ...
		      "stateSave": true,
		      "ajax": {
		                 "url": "vistas/serverProcessing/administrativa/mas24HrsSinAgenda.php",
		                 data: function (d) {
		                     d.idUsuario = $('#idUsuario').val();//paso el id del usuario para filtrar por sesion en el serverSide de datatable
		                 },
		             },
	...
	if (filtro == 'mas10DiasSinAtencion') {
		$(function () {
		    $('#tPacientesDerivadosAdministrativa').DataTable({
		      ...
		      "stateSave": true,
		      "ajax": {
		                 "url": "vistas/serverProcessing/administrativa/mas10DiasSinAtencion.php",
		                 data: function (d) {
		                     d.idUsuario = $('#idUsuario').val();//paso el id del usuario para filtrar por sesion en el serverSide de datatable
		                 },
		             },
	...
	if (filtro == 'quirurgicas') {
		$(function () {
		    $('#tPacientesDerivadosAdministrativa').DataTable({
		      ...
		      "stateSave": true,
		      "ajax": {
		                 "url": "vistas/serverProcessing/administrativa/quirurgicas.php",
		                 data: function (d) {
		                     d.idUsuario = $('#idUsuario').val();//paso el id del usuario para filtrar por sesion en el serverSide de datatable
		                 },
		             },
	...
	if (filtro == 'solicita_autorizacion') {
		$(function () {
		    $('#tPacientesDerivadosAdministrativa').DataTable({
		      ...
		      "ajax": {
		                 "url": "vistas/serverProcessing/administrativa/solicitaAutorizacion.php",
		                 data: function (d) {
		                     d.idUsuario = $('#idUsuario').val();//paso el id del usuario para filtrar por sesion en el serverSide de datatable
		                 },
		             },
	...
	if (filtro == 'para_cierre') {
		$(function () {
		    $('#tPacientesDerivadosAdministrativa').DataTable({
		      ...
		      "lengthMenu": [[10, 50, -1], [10, 50, "Todos"]],
		      "ajax": {
		                 "url": "vistas/serverProcessing/administrativa/paraCierre.php",
		                 data: function (d) {
		                     d.idUsuario = $('#idUsuario').val();//paso el id del usuario para filtrar por sesion en el serverSide de datatable
		                 },
		             },
		...
		$(function () {
		    $('#tPacientesDerivadosAdministrativa').DataTable({
		      ...
		      "lengthMenu": [[10, 50, -1], [10, 50, "Todos"]],
		      "ajax": {
		                 "url": "vistas/serverProcessing/administrativa/solicitaAutorizacionEnPlazo.php",
		                 data: function (d) {
		                     d.idUsuario = $('#idUsuario').val();//paso el id del usuario para filtrar por sesion en el serverSide de datatable
		                 },
		             },
		...
		$(function () {
		    $('#tPacientesDerivadosAdministrativa').DataTable({
		      ...
		      "lengthMenu": [[10, 50, -1], [10, 50, "Todos"]],
		      "ajax": {
		                 "url": "vistas/serverProcessing/administrativa/solicitaAutorizacionRetrasada.php",
		                 data: function (d) {
		                     d.idUsuario = $('#idUsuario').val();//paso el id del usuario para filtrar por sesion en el serverSide de datatable
		                 },
		             },
	...
	if (filtro == 'prestador_asignado') {
		$(function () {
		    $('#tPacientesDerivadosAdministrativa').DataTable({
		      ...
		      "lengthMenu": [[10, 50, -1], [10, 50, "Todos"]],
		      "ajax": {
		                 "url": "vistas/serverProcessing/administrativa/prestadorAsignado.php",
		                 data: function (d) {
		                     d.idUsuario = $('#idUsuario').val();//paso el id del usuario para filtrar por sesion en el serverSide de datatable
		                 },
		             },
