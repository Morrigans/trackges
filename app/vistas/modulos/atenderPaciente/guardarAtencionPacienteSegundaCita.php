...
$comentarioBitacora = 'Segunda consulta de la derivacion numero D0'.$idDerivacion.'.<br/>Atiende paciente: '.$slAtiendePaciente.'. <br/>Quirúrgico: '.$slQuirurgico.'.<br/>Comentario atención: '.$slComentarioAtiendePaciente;
