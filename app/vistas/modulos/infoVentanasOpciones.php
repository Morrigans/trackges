...
$query_qrConvenio= "SELECT * FROM $MM_oirs_DATABASE.convenio WHERE ID_CONVENIO = '$codConvenio'";
...
<div class="col-md-12">
	<div class="table-responsive">
			...
			<tr>
				...
				<td><?php echo utf8_encode($qrConvenio->Fields('DESC_CONVENIO')); ?></td>
			</tr>
			<tr>
					...
					<?php 
						if ($totalRows_qrDerivacionCanasta == 0) {
							...
							while (!$qrDerivacionCanasta->EOF) {
								$idCanastaPatologia = $qrDerivacionCanasta->Fields('ID_CANASTA');
