...
$updateSQL = sprintf("UPDATE $MM_oirs_DATABASE.derivaciones_canastas SET ESTADO=%s, OBSERVACION=%s, FECHA_FIN_CANASTA=%s, AUDITORIA=%s, MOTIVO_FIN_CANASTA=%s WHERE ID_CANASTA_PATOLOGIA = '$idDerivacionCanasta'",
