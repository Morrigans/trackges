	...
	<body>
        <div class="card-body">
        	<div class="row">
	  		...
	  		<input type="hidden" id="hdIdDerivacion" value="<?php echo $idDerivacion ?>">
	</body>
</html>
...
<script>
	...
	$('#dvInfoVentanasOpcionesAsignarTeam').load('vistas/modulos/infoVentanasOpciones.php?idDerivacion='+idDerivacion);
...
function fnGuardaTeamProfesionales(idDerivacion, tipoUsuario){
  ...
  $.ajax({
    type: "POST",
    url: "vistas/modulos/asignarTeamGestion/asignarTeamGestion.php",
    data: cadena,
    success:function(r){
