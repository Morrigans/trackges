...
$comentarioBitacora = 'El profesional '.$nomProfesional.' rut: '.$codRutPro.' de profesion: '.utf8_encode($profesionSinGenero).', fue asignado a la derivacion numero D0'.$idDerivacion.' Folio Rigth Now '.$folio;
