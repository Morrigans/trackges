...
$insertSQL = sprintf("INSERT INTO $MM_oirs_DATABASE.events (ID_DERIVACION, TIPO_ATENCION, cod_rutpac, ID_PACIENTE, cod_rutpro, ID_PROFESIONAL, start, hora, color, ESTADO_CITA, COMENTARIO, FECHA_REGISTRO, HORA_REGISTRO, RUT_SESION) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
