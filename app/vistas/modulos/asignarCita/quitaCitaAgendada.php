...
$query_qrDerivaciones= "SELECT * FROM $MM_oirs_DATABASE.derivaciones WHERE ID_DERIVACION = '$idDerivacion'";
...
$query_qrEvents= "SELECT * FROM $MM_oirs_DATABASE.events WHERE id = '$idEvents'";
