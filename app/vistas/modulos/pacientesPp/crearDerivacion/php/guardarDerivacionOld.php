...
$idPaciente = $qrPaciente->Fields('ID'); 
     ...
     $insertSQL = sprintf("INSERT INTO $MM_oirs_DATABASE.derivaciones (COD_RUTPAC, ID_CONVENIO, CODIGO_TIPO_PATOLOGIA, CODIGO_PATOLOGIA, CODIGO_ETAPA_PATOLOGIA, CODIGO_CANASTA_PATOLOGIA, FECHA_DERIVACION, FECHA_ACTIVACION, ENFERMERA, ADMINISTRATIVA, SESION, AUDITORIA, ESTADO, COMENTARIO, ID_PATOLOGIA, ID_PACIENTE) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
