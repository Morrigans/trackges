...
$query_select = "SELECT * FROM $MM_oirs_DATABASE.canasta_patologia WHERE CODIGO_ETAPA_PATOLOGIA='$etapaPatologia' AND DECRETO = '$decreto' ORDER BY DESC_CANASTA_PATOLOGIA ASC";
