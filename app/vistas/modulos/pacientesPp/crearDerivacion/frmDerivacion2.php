  ...
  <div class="card card-info">
    ...
    <!-- <form class="form-horizontal" method="POST" action="addEvent.php"> -->
      <div class="row">
        ...
        <div class="input-group mb-3 col-sm-3">
            <button class="btn btn-info" type="button" id="btnBuscaPacienteParaAgendar" onclick="fnBuscaPacientePp()"><i class="fas fa-search"></i> Iniciar derivación</button>
        </div>
