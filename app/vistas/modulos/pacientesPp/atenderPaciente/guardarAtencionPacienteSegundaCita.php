...
$estado = 'segundaConsultaAtendida';
...
$comentarioBitacora = 'Segunda consulta de la derivacion numero P0'.$idDerivacion.'.<br/>Atiende paciente: '.$slAtiendePaciente.'. <br/>Quirúrgico: '.$slQuirurgico.'.<br/>Comentario atención: '.$slComentarioAtiendePaciente;
...
//#############################################################  guarda daTos ICRS##########################################################
if ($idDerivacionPp != '') {
    $asuntoPp= 'Segunda consulta  (D0'.$idDerivacionPp.')';
    $estadoNoti='nuevo';
    ...
    $comentarioBitacoraPp = 'Segunda consulta de la derivacion numero D0'.$idDerivacionPp.'.<br/>Atiende paciente: '.$slAtiendePaciente.'. <br/>Corresponde derivación: '.$slCorrespondeCanasta.'. <br/>Comentario atención: '.$slComentarioAtiendePaciente;
