...
$insertSQL = sprintf("INSERT INTO $MM_oirs_DATABASE.atenciones_pp (ID_DERIVACION, ID_CITACION, ATENDIDO, CORRESPONDE, COMENTARIO, FECHA_REGISTRO, HORA_REGISTRO, RUTA_DOCUMENTO) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
...
$comentarioBitacora = 'Primera consulta de la derivacion numero P0'.$idDerivacion.'.<br/>Atiende paciente: '.$slAtiendePaciente.'. <br/>Corresponde derivación: '.$slCorrespondeCanasta.'. <br/>Comentario atención: '.$slComentarioAtiendePaciente;
...
//#############################################################  guarda daTos ICRS##########################################################
if ($idDerivacionPp != '') {
    $asuntoPp= 'Primera consulta  (D0'.$idDerivacionPp.')';
    $estadoNoti='nuevo';
    ...
    $comentarioBitacoraPp = 'Primera consulta de la derivacion numero D0'.$idDerivacionPp.'.<br/>Atiende paciente: '.$slAtiendePaciente.'. <br/>Corresponde derivación: '.$slCorrespondeCanasta.'. <br/>Comentario atención: '.$slComentarioAtiendePaciente;
