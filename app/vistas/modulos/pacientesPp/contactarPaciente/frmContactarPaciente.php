...
$query_qrBuscaAlarmas = "SELECT * FROM $MM_oirs_DATABASE.bitacora_pp WHERE PROGRAMADO = 'si' AND FECHA_PROGRAMACION <= '$hoy' AND SESION = '$usuario' order by FECHA_PROGRAMACION desc";
        ...
        <div class="card-body">
        	<div class="row">
	        	...
	        	<div class="col-md-6"><h2>Contactar paciente:</h2></div>
						...
						<div class="col-md-6" id="dvInfoVentanasOpcionesContactarPacientePp"></div>
						...
						<div class="col-md-6">
							...
							<div class="col-sm-6" id="dvMuestraBtnAdjuntarArchivoContactarPaciente">
							  <div class="form-group">
							      <a href="#" class="btn btn-success btn-block" onclick="$('#dvCargaAdjuntarContactarPaciente').load('vistas/modulos/pacientesPp/bitacora/adjuntaDoc/adjuntaDocumentoContactarPaciente.php?idDerivacion='+<?php echo $idDerivacion?>), $('#dvCargaAdjuntarContactarPaciente').show();"><i class="fas fa-paperclip"></i> Adjuntar Archivo</a>
							  </div>
							</div>
					...
					<div class="modal-footer" align="right">	
					    ...
					    <button id="btnGuardaContacto" type="button" class="btn btn-success" onclick="fnGuardaContacto('<?php echo $idDerivacion ?>','<?php echo $idDerivacionPp ?>','<?php echo $tipoUsuario ?>')">Guardar contacto con paciente</button>
			  	</div>     
	  		</div>
...
<script>
	...
	$('#dvInfoVentanasOpcionesContactarPacientePp').load('vistas/modulos/infoVentanasOpcionesPp.php?idDerivacion='+idDerivacion);
...
function fnGuardaContacto(idDerivacion,idDerivacionPp,tipoUsuario){
  ...
  $.ajax({
    type: "POST",
    url: "vistas/modulos/pacientesPp/contactarPaciente/contactarPaciente.php",
    data: cadena,
    success:function(r){
...
function fnNumeroContactos(tipoContacto, idDerivacion){
  ...
  $.ajax({
    type: "POST",
    url: "vistas/modulos/pacientesPp/contactarPaciente/numeroContactos.php",
    data: cadena,
    success:function(r){
...
function fnQuitarEliminaAdjuntoContactarPaciente(){
  ...
  $.ajax({
      type: "POST",
      url: "vistas/modulos/pacientesPp/bitacora/adjuntaDoc/docs/eliminaAdjuntoAtencion.php",
      data: cadena,
      success: function(r) {
      	$("#hdRutaAdjuntaDocContactarPaciente").val('');
      	$("#dvMuestraPreDocAdjuntoContactarPaciente").hide();
...
function fnQuitarEliminaAudioContactarPaciente(){
  ...
  $.ajax({
      type: "POST",
      url: "vistas/modulos/pacientesPp/bitacora/modals/audios/eliminaAudioContactoPaciente.php",
      data: cadena,
      success: function(r) {
      	$("#rutaAudio").val('');
      	$("#grabarLlamada").show();
...
function fnMuestraAdjuntoContactarPaciente(){
		rutaAdjuntaDocContactarPaciente = $("#hdRutaAdjuntaDocContactarPaciente").val();
		window.open('vistas/modulos/pacientesPp/bitacora/adjuntaDoc/'+rutaAdjuntaDocContactarPaciente, '_blank');
}
</script>
