...
$query_qrPatologiaTabla  = "SELECT * FROM $MM_oirs_DATABASE.patologia_pp WHERE ID_TIPO_PATOLOGIA='1' ORDER BY DESC_PATOLOGIA ASC";
        ...
        <div class="card-body">
        	<div class="row">
	        	...
	        	<div class="col-md-6"><h2>Asignar Patologia, etapa y canasta</h2></div>
						<div class="col-md-6" id="dvInfoVentanasOpcionesAsignarPatologia"></div>	
						<div class="col-md-6">
							...
							<div class="input-group mb-3 col-sm-12">
							    ...
							    <select name="slPatologiaDerivacion" id="slPatologiaDerivacion" class="form-control input-sm select2bs4" onchange="fnFiltraEtapasPatologiasPp()">
							         <option value="">Seleccione...</option>
							         <?php
							        while(!$qrPatologiaTabla->EOF){  ?> 	 
							            <option value="<?php echo $qrPatologiaTabla->Fields('ID_PATOLOGIA')?>"><?php echo utf8_encode($qrPatologiaTabla->Fields('DESC_PATOLOGIA'))?></option>
							        <?php
							...
							<div class="input-group mb-3 col-sm-12">
							    ...
							    <select name="slEtapaPatologiaDerivacion" id="slEtapaPatologiaDerivacion" class="form-control input-sm" onchange="fnFiltraCanastasPatologiasPp()">
							    </select>
							</div>
							...
							<div class="input-group mb-3 col-sm-12">
							    ...
							    <select name="slCanastaPatologiaDerivacion" id="slCanastaPatologiaDerivacion" class="form-control input-sm" onchange="fnExtraeTiempoLimitePp(this.value)">
							    </select>
...
<script>
	...
	$('#dvInfoVentanasOpcionesAsignarPatologia').load('vistas/modulos/infoVentanasOpcionesPp.php?idDerivacion='+idDerivacion);

	function fnFiltraEtapasPatologiasPp(){
	    ...
	    $("#slPatologiaDerivacion option:selected").each(function () {        
	        ...
	        if (tipoPatologia == '2') {
	          ...
	          $.post("vistas/modulos/pacientesPp/asignarPatologiaEtapaCanasta/filtraEtapasPatologias.php",
	...
	function fnFiltraCanastasPatologiaspP(){
      $("#slEtapaPatologiaDerivacion option:selected").each(function () {
          etapaPatologia=$(this).val();
          decreto = $("#decreto").val();
          $.post("vistas/modulos/pacientesPp/asignarPatologiaEtapaCanasta/filtraCanastasPatologias.php",
    ...
    function fnExtraeTiempoLimitePp(canasta){
    cadena = 'canasta='+ canasta;
    
      $.ajax({
       url: 'vistas/modulos/pacientesPp/asignarPatologiaEtapaCanasta/extraeTiempoLimite.php',
       type: "POST",
       data: cadena,
       success: function(r) {
