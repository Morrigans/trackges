...
$updateSQL = sprintf("UPDATE $MM_oirs_DATABASE.derivaciones_canastas_pp SET OBSERVACION=%s, MOTIVO_FIN_CANASTA=%s WHERE ID_CANASTA_PATOLOGIA = '$idDerivacionCanasta'",
