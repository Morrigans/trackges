...
$query_qrCanastaDerivacion = "SELECT * FROM $MM_oirs_DATABASE.derivaciones_canastas_pp WHERE ID_CANASTA_PATOLOGIA = '$canasta'";
...
function fnMotivoVencimientoCanasta(idDerivacion,idEtapaPatologia,codEtapaPatologia,canasta,prestador){
	...
	cadena = 'idDerivacion=' + idDerivacion +
		...
		$.ajax({
			type:"post",
			data:cadena,
			url:'vistas/modulos/pacientesPp/derivacion/modals/guardaMotivoVencimientoCanasta.php',
			success:function(r){
				if (r == 1) {
