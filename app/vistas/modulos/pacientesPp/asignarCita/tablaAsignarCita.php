...
$query_slTeamAtencion = ("SELECT * FROM $MM_oirs_DATABASE.team_gestion where ID_DERIVACION = '$idDerivacion'"); 
...
<script>
    function fnDesasociarTeamGestion(id,idDerivacion,rutPro) {
        ...
        $.ajax({
            type: "POST",
            url: "vistas/inicio/inicioSupervisora/modals/pacientesPp/asignarTeamGestion/desasociarTeamGestion.php",
            data: cadena,
            success: function(r) {
                if (r == 1) {
                    $("#dvTablaTeamGestion").load('vistas/inicio/inicioSupervisora/modals/asignarTeamGestion/tablaTeamGestion.php?idDerivacion='+idDerivacion);
