<div class="modal fade" id="modalAudiosPp" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                        ...
                        navigator.mediaDevices.getUserMedia({
                            ...
                            .then(stream => { 
                                ...
                                mediaRecorder.addEventListener("stop", () => {
                                    ...
                                    const RUTA_SERVIDOR = "vistas/modulos/pacientesPp/bitacora/modals/guardarAudios.php?idBitacora="+$('#idBitacora').val() + "&origen="+$('#origen').val();
