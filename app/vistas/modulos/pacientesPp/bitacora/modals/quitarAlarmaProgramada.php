...
$insertSQL = sprintf("DELETE from $MM_oirs_DATABASE.alarmas_pp where ID_ALARMA='$idAlarma'");
...
if ($totalRows_qrAlarmas == 0) {
    $updateSQL = sprintf("UPDATE $MM_oirs_DATABASE.bitacora_pp SET PROGRAMADO=%s WHERE ID_BITACORA= '$idBitacora'",
