...
$query_qrDerivacion= "SELECT * FROM $MM_oirs_DATABASE.bitacora_pp WHERE ID_BITACORA = '$idBitacora'";
...
<html>
	<body>
        	<div class="row">
				...
				<div class="col-sm-12">
				  <div id="tablaDestinatariosAlarmasPp"></div>
				</div>
...
<script type="text/javascript">
	...
	$("#tablaDestinatariosAlarmasPp").load('vistas/modulos/pacientesPp/bitacora/modals/tablaDestinatariosAlarmas.php?idBitacora='+idBitacora);
	...
	function fnProgramarTarea(idBitacora,usuario,idDerivacion){
		...
		$.ajax({
			type:"post",
			data:cadena,
			url:'vistas/modulos/pacientesPp/bitacora/modals/programarTarea.php',
			success:function(r){
				if (r == 1) {
					Swal.fire({
					  position: 'top-end',
					...
					$("#tablaDestinatariosAlarmasPp").load('vistas/modulos/pacientesPp/bitacora/modals/tablaDestinatariosAlarmas.php?idBitacora='+idBitacora);
					//setTimeout(function (){ $('#dvTablaBitacora').load('vistas/modulos/pacientesPp/bitacora/modals/tablaBitacora.php?idDerivacion='+idDerivacion); }, 1501);//retardo PARA EVITAR dropdown
...
function fnCerrarProgramarTarea(idDerivacion){
	setTimeout(function (){ $('#dvTablaBitacoraPp').load('vistas/modulos/pacientesPp/bitacora/modals/tablaBitacora.php?idDerivacion='+idDerivacion); }, 1);//retardo PARA EVITAR dropdown
}
