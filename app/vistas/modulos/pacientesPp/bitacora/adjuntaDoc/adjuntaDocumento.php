...
<head>
 ...
 <!-- dropzonejs -->
  <link rel="stylesheet" href="vistas/modulos/pacientesPp/bitacora/adjuntaDoc/css/dropzone.css">
    <!-- dropzonejs -->
<script src="vistas/modulos/pacientesPp/bitacora/adjuntaDoc/js/dropzone.js"></script>
...
var myDropzone = new Dropzone(document.body, {
    url: "vistas/modulos/pacientesPp/bitacora/adjuntaDoc/sube.php?idBitacora="+<?php echo $idBitacora?>,
    paramName: "file",
...
myDropzone.on("queuecomplete", function(progress) {
    ...
    setTimeout(function(){
        ...
        $('#dvTablaBitacoraPp').load('vistas/modulos/pacientesPp/bitacora/modals/tablaBitacora.php?idDerivacion=' +<?php echo $idDerivacion?>);
        // $('#dvfrmDetalleDerivacion').load('vistas/modulos/pacientesPp//frmDetalleDerivacion.php?idDerivacion=' +<?php echo $idDerivacion?>);
        // $('#dvfrmDetalleDerivacionGestora').load('vistas/modulos/pacientesPp/inicio/inicioGestora/modals/derivacion/frmDetalleDerivacion.php?idDerivacion=' +<?php echo $idDerivacion?>);
    }, 2000);
    //fnCargarMiContenido('vistas/modulos/pacientesPp/bitacora/adjuntaDoc/docs/tblMuestraMisPagosPendientes.php','content-wrapper');
