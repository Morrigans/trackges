...
$insertSQL = sprintf("INSERT INTO $MM_oirs_DATABASE.login (USUARIO, ID_PRESTADOR, NOMBRE,TIPO,ID_ESPECIALIDAD, ID_SUBESPECIALIDAD, FONO, MAIL, RUT_SESION, FECHA_AUDITORIA, PASS, NIVEL) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
    ...
    GetSQLValueString(utf8_decode($nombreProfesional), "text"),
    GetSQLValueString(utf8_decode($tipoProfesional), "text"),
    GetSQLValueString(utf8_decode($slEspecialidad), "int"),
    GetSQLValueString(utf8_decode($slSubespecialidad), "int"),
