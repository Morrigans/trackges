...
<script>
	...
	$('#dvInfoVentanasOpcionesBitacora').load('vistas/modulos/infoVentanasOpciones.php?idDerivacion='+idDerivacion);
...
setTimeout(function (){ $('#dvTablaBitacora').load('vistas/bitacora/modals/tablaBitacora.php?idDerivacion=' + idDerivacion); }, 500);//retardo un milisegundo (1000 es un segundo) para evitar problema de tabla cortada
