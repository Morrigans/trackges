...
$insertSQL = sprintf("INSERT INTO $MM_oirs_DATABASE.alarmas (ID_BITACORA, MENSAJE, USUARIO_EMISOR, USUARIO_RECEPTOR, ESTADO, FECHA_ALARMA, FECHA_REGISTRO, HORA_REGISTRO) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
