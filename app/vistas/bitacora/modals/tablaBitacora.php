	      						...
	      						if ($qrBitacora->Fields('SESION') == $usuario) {
      								...
      								if($ruta!='' and $qrBitacora->Fields('SESION') != null){ 
      									...
      									<?php }else{ ?>
      										...
      										<span class=""><a target="_blank" class="btn btn-xs btn-success" href="https://crss.redges.cl/vistas/bitacora/adjuntaDoc/<?php echo $ruta; ?>" ><i class="far fa-file-pdf"></i></a></span>
