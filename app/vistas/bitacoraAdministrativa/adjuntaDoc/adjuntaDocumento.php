  ...
  <br>
        <div class="container" >
        	...
        	<!-- <input type="text" class="form-control input-sm" name="hdIdBitacora" id="hdIdBitacora" value="<?php echo $idBitacora ?>" /> -->
          	<div id="dvBitacoraAdm" class="col-md-12">
           		<div class="callout callout-info">
            		<div class="card-body box-profile">
		                ...
		                <div class="table table-striped files" id="previews">
		                  <div id="dzBitacoraAdm" class="row mt-2">
		                    <div class="col-auto">
...
var previewNode = document.querySelector("#dzBitacoraAdm");
previewNode.id = "";
...
var myDropzone = new Dropzone(document.body, {
    url: "vistas/bitacoraAdministrativa/adjuntaDoc/sube.php?idBitacora="+<?php echo $idBitacora?>,
    paramName: "file",
