...
LEFT JOIN prestador g
ON a.RUT_PRESTADOR = g.RUT_PRESTADOR 
						...
						if ($row[2]=='aceptada') {
							return ' 
								<div class="btn-group">
									...
									<a class="dropdown-item" href="#" data-toggle="modal" data-target="#modalAsignarMedicoCaso" onclick="modalAsignarMedicoCaso('.$d.')">Asignar Médico Tratante</a>
