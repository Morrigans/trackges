...
$query_qrNotificación = "SELECT * FROM $MM_oirs_DATABASE.2_notificaciones where ID='$id'";
...
<strong>Derivación:</strong> <a href="#" data-dismiss="modal"><span class="badge badge-warning" data-toggle="modal" data-target="#modalBitacora" onclick="fnfrmBitacora('<?php echo $qrNotificación->Fields('ID_DERIVACION') ?>')"><font size="3"><?php echo $qrNotificación->Fields('FOLIO'); ?></font></span></a></p><br>
...
<script type="text/javascript">
	...
	function fnCambiaEstadoNotificacion(id){
		...
		$.ajax({
		    type: "POST",
		    url: "2.0/notificaciones/php/cambiaEstadoNotificacion.php",
		    data: cadena,
		    success: function(r) {
