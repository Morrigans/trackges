...
<script>
  $('#dvMenuDashboardFinanciero').load('2.0/vistas/menuLateral/menuDashboardFinanciero.php');
  $('#dvMenuDashboardComercial').load('2.0/vistas/menuLateral/menuDashboardComercial.php');
  $('#dvMenuDashboardOperacional').load('2.0/vistas/menuLateral/menuDashboardOperacional.php');
