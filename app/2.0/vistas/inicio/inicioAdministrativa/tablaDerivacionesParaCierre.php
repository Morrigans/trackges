...
<table id="tPacientesDerivadosParaCierre" class="table table-bordered table-striped table-hover table-sm">
...
<script type="text/javascript">
	...
	if (filtro == 'para_cierre') {
		$(function () {
		    $('#tPacientesDerivadosParaCierre').DataTable({
		      "paging": true,
		      "lengthChange": true,
		      "searching": true,
		      "ordering": true,
		      ...
		      "ajax": {
		                 "url": "2.0/vistas/serverProcessing/administrativa/paraCierre.php",
		                 data: function (d) {
