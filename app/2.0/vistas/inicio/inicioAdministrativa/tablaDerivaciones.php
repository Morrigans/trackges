	...
	if (filtro == 'todo') { 
		$(function () {
		    $('#tPacientesDerivadosAdministrativa').DataTable({
		      ...
		      "ajax": {
		                 "url": "2.0/vistas/serverProcessing/administrativa/derivaciones.php",
		                 data: function (d) {
	...
	if (filtro == 'sin_bitacora') {
		$(function () {
		    $('#tPacientesDerivadosAdministrativa').DataTable({
		      ...
		      "lengthMenu": [[10, 50, -1], [10, 50, "Todos"]],
		      "ajax": {
		                 "url": "2.0/vistas/serverProcessing/administrativa/diasSinBitacora.php",
		                 data: function (d) {
		                     d.idUsuario = $('#idUsuario').val();//paso el id del usuario para filtrar por sesion en el serverSide de datatable
		                 },
		             },
	...
	if (filtro == 'activas') { 
		$(function () {
		    $('#tPacientesDerivadosAdministrativa').DataTable({
		      ...
		      "lengthMenu": [[10, 50, -1], [10, 50, "Todos"]],
		      "ajax": {
		                 "url": "2.0/vistas/serverProcessing/administrativa/activas.php",
		                 data: function (d) {
		                     d.idUsuario = $('#idUsuario').val();//paso el id del usuario para filtrar por sesion en el serverSide de datatable
		                 },
		             },
