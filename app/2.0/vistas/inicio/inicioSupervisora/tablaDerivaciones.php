...
if ($estado =='alta') { ?>
	<input type="hidden" id="filtro" value="alta">
<?php } 

if ($estado =='asignado') { ?>
	<input type="hidden" id="filtro" value="asignado">
<?php } 
	...
	if (filtro == 'sin_bitacora') { 
		$(function () {
		    $('#tPacientesDerivados').DataTable({
		      ...
		      "lengthMenu": [[10, 50, -1], [10, 50, "Todos"]],
		      "ajax": {
		                 "url": "2.0/vistas/serverProcessing/diasSinBitacora.php",
		                 data: function (d) {
		                     d.idUsuario = $('#idUsuario').val();//paso el id del usuario para filtrar por sesion en el serverSide de datatable
		                 },
		             },
	...
	if (filtro == 'alta') { 
		$(function () {
		    $('#tPacientesDerivados').DataTable({
		      ...
		      "lengthMenu": [[10, 50, -1], [10, 50, "Todos"]],
		      "ajax": {
		                 "url": "2.0/vistas/serverProcessing/altas.php",
		                 data: function (d) {
		                     d.idUsuario = $('#idUsuario').val();//paso el id del usuario para filtrar por sesion en el serverSide de datatable
		                 },
		             },
	...
	if (filtro == 'asignado') { 
		$(function () {
		    $('#tPacientesDerivados').DataTable({
		      ...
		      "lengthMenu": [[10, 50, -1], [10, 50, "Todos"]],
		      "ajax": {
		                 "url": "2.0/vistas/serverProcessing/asignados.php",
		                 data: function (d) {
		                     d.idUsuario = $('#idUsuario').val();//paso el id del usuario para filtrar por sesion en el serverSide de datatable
		                 },
		             },
	...
	if (filtro == 'activas') { 
		$(function () {
		    $('#tPacientesDerivados').DataTable({
		      ...
		      "lengthMenu": [[10, 50, -1], [10, 50, "Todos"]],
		      "ajax": {
		                 "url": "2.0/vistas/serverProcessing/activas.php",
		                 data: function (d) {
		                     d.idUsuario = $('#idUsuario').val();//paso el id del usuario para filtrar por sesion en el serverSide de datatable
		                 },
		             },
