...
";
$qrSeguimientoQuirurgico = $oirs->SelectLimit($query_qrSeguimientoQuirurgico) or die($oirs->ErrorMsg());
$totalRows_qrSeguimientoQuirurgico = $qrSeguimientoQuirurgico->RecordCount();

$query_qrSeguimientoOncologico = "
    SELECT 
  a.N_DERIVACION
...
";
$qrSeguimientoOncologico = $oirs->SelectLimit($query_qrSeguimientoOncologico) or die($oirs->ErrorMsg());
$totalRows_qrSeguimientoOncologico = $qrSeguimientoOncologico->RecordCount();

$query_qrActividadQuirurgica = "
SELECT 
          a.N_DERIVACION,
          a.ID_DERIVACION,
          a.PROBLEMA_SALUD,
...
";
$qrActividadQuirurgica = $oirs->SelectLimit($query_qrActividadQuirurgica) or die($oirs->ErrorMsg());
$totalRows_qrActividadQuirurgica = $qrActividadQuirurgica->RecordCount();
...
$query_qrAlta = "
    ...
    WHERE a.ESTADO_RN = 'Alta Paciente'


";
$qrAlta = $oirs->SelectLimit($query_qrAlta) or die($oirs->ErrorMsg());
$totalRows_qrAlta = $qrAlta->RecordCount();
...
";
$qrAsignado = $oirs->SelectLimit($query_qrAsignado) or die($oirs->ErrorMsg());
$totalRows_qrAsignado = $qrAsignado->RecordCount();
?>
            ...
            <div class="row">
                  ...
                  <!-- <div class="col-lg-3 col-6">
                      <div class="small-box bg-white">
                        <a class="small-box-footer" style="pointer-events: none;"><h3>.</h3> Actividad Quirúrgica En construcción... <i class="fas fa-arrow-circle-right"></i></a>
                      </div>
                    </div> -->
                  <div class="col-lg-3 col-6">
                    <div class="small-box bg-primary">
                      <a href="#" class="small-box-footer" onclick="fnFiltraTablaDerivacionesActividadQuirurgica('actividad_quirurgica')"><h3><?php echo $totalRows_qrActividadQuirurgica ?></h3> Actividad Quirúrgica <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                  </div>
                  ...
                  <div class="col-lg-3 col-6">
                    ...
                    <div class="col-lg-3 col-6">
                        <div class="small-box bg-primary">
                          <a href="#" class="small-box-footer" onclick="fnFiltraTablaDerivacionesSeguimientoQuirurgico('seguimiento_quirurgico')"><h3><?php echo $totalRows_qrSeguimientoQuirurgico ?></h3> Seguimiento Quirúrgico <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                      </div>
                    ...
                    <div class="col-lg-3 col-6">
                      <div class="small-box bg-primary">
                        <a href="#" class="small-box-footer" onclick="fnFiltraTablaDerivacionesSeguimientoOncologico('seguimiento_oncologico')"><h3><?php echo $totalRows_qrSeguimientoOncologico ?></h3> Seguimiento Oncológico <i class="fas fa-arrow-circle-right"></i></a>
                      </div>
                    </div>
                    <div class="col-lg-3 col-6">
                      <div class="small-box bg-info">
                        <a href="#" class="small-box-footer" onclick="fnFiltraTablaDerivaciones('alta')"><h3><?php echo $totalRows_qrAlta ?></h3> Alta <i class="fas fa-arrow-circle-right"></i></a>
                      </div>
                    </div>
                    <div class="col-lg-3 col-6">
                      <div class="small-box bg-info">
                        <a href="#" class="small-box-footer" onclick="fnFiltraTablaDerivaciones('asignado')"><h3><?php echo $totalRows_qrAsignado ?></h3> Asignados <i class="fas fa-arrow-circle-right"></i></a>
                      </div>
                    </div>
...
$('#dvTablaDerivaciones').load('2.0/vistas/inicio/inicioSupervisora/tablaDerivaciones.php');
...
function fnFiltraTablaDerivaciones(estado,vencidas){
    $('#dvTablaDerivaciones').html('<img src="images/loading.gif"/>');
    $('#dvTablaDerivaciones').load('2.0/vistas/inicio/inicioSupervisora/tablaDerivaciones.php?estado=' + estado+'&vencidas='+vencidas);

}
function fnFiltraTablaDerivacionesSeguimientoQuirurgico(estado,vencidas){
    $('#dvTablaDerivaciones').html('<img src="images/loading.gif"/>');
    $('#dvTablaDerivaciones').load('2.0/vistas/inicio/inicioSupervisora/tablaDerivacionesSeguimientoQuirurgico.php?estado=' + estado+'&vencidas='+vencidas);

}
function fnFiltraTablaDerivacionesSeguimientoOncologico(estado,vencidas){
    $('#dvTablaDerivaciones').html('<img src="images/loading.gif"/>');
    $('#dvTablaDerivaciones').load('2.0/vistas/inicio/inicioSupervisora/tablaDerivacionesSeguimientoOncologico.php?estado=' + estado+'&vencidas='+vencidas);

}
function fnFiltraTablaDerivacionesActividadQuirurgica(estado,vencidas){
    $('#dvTablaDerivaciones').html('<img src="images/loading.gif"/>');
    $('#dvTablaDerivaciones').load('2.0/vistas/inicio/inicioSupervisora/tablaDerivacionesActividadQuirurgica.php?estado=' + estado+'&vencidas='+vencidas);
...
function fnFiltraTablaApiCenso(estado,vencidas){
    $('#dvTablaDerivaciones').html('<img src="images/loading.gif"/>');
    $('#dvTablaDerivaciones').load('2.0/vistas/inicio/inicioSupervisora/tablaDerivacionesApiCenso.php?estado=' + estado+'&vencidas='+vencidas);
}
