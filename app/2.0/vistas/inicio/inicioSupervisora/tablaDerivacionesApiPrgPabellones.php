...
require_once('../../modulos/motRetPabPrg/modalMotRetPabPrg.php');
...
if ($estado =='prgPab') { ?>
	<input type="hidden" id="filtro" value="prgPab">
<?php }
?>
...
<table id="tPacientesPrgPabellones" class="table table-bordered table-striped table-hover table-sm">
	<thead class="table-info">
		<tr align="center">
			...
			<th><font size="2">Estado Prg</font></th>
			<th><font size="2">Gestora</font></th>
			<th><font size="2">Motivo retraso</font></th> 
...
<script type="text/javascript">
	...
	if (filtro == 'prgPab') {
		$(function () {
		    $('#tPacientesPrgPabellones').DataTable({
		      "paging": true,
		      "lengthChange": true,
		      "searching": true,
		      "ordering": true,
		      ...
		      "ajax": {
		                 "url": "2.0/vistas/serverProcessing/apiPrgPabellones.php",
		                 data: function (d) {
