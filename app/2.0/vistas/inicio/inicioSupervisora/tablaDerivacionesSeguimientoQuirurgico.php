...
if ($estado =='seguimiento_quirurgico') { ?>
	<input type="hidden" id="filtro" value="seguimiento_quirurgico">
<?php } 
...
<table id="tSeguimientoQuirurgico" class="table table-bordered table-striped table-hover table-sm">
	<thead class="table-info">
		<tr align="center">
			...
			<th><font size="2">Fecha límite</font></th>
...
<script type="text/javascript">
	...
	if (filtro == 'seguimiento_quirurgico') { 
		$(function () {
		    $('#tSeguimientoQuirurgico').DataTable({
		      "paging": true,
		      "lengthChange": true,
		      "searching": true,
		      "ordering": true,
		      ...
		      "ajax": {
		                 "url": "2.0/vistas/serverProcessing/seguimientoQuirurgico.php",
		                 data: function (d) {
