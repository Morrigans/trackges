...
if ($estado =='seguimiento_oncologico') { ?>
	<input type="hidden" id="filtro" value="seguimiento_oncologico">
<?php } 
...
<table id="tSeguimientoOncologico" class="table table-bordered table-striped table-hover table-sm">
...
<script type="text/javascript">
	...
	if (filtro == 'seguimiento_oncologico') { 
		$(function () {
		    $('#tSeguimientoOncologico').DataTable({
		      "paging": true,
		      "lengthChange": true,
		      "searching": true,
		      "ordering": true,
		      ...
		      "ajax": {
		                 "url": "2.0/vistas/serverProcessing/seguimientoOncologico.php",
		                 data: function (d) {
