...
$('#dvTablaDerivaciones').load('2.0/vistas/inicio/inicioTens/tablaDerivaciones.php');
...
function fnFiltraTablaDerivaciones(estado,vencidas){
    $('#dvTablaDerivaciones').html('<img src="images/loading.gif"/>');
    $('#dvTablaDerivaciones').load('2.0/vistas/inicio/inicioTens/tablaDerivaciones.php?estado=' + estado+'&vencidas='+vencidas);
...
function fnFiltraTablaApiCenso(estado,vencidas){
    $('#dvTablaDerivaciones').html('<img src="images/loading.gif"/>');
    $('#dvTablaDerivaciones').load('2.0/vistas/inicio/inicioTens/tablaDerivacionesApiCenso.php?estado=' + estado+'&vencidas='+vencidas);
}
