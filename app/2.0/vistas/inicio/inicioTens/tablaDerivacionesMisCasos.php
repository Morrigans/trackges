...
if ($estado =='mis_casos') { ?>
	<input type="hidden" id="filtro" value="mis_casos">
<?php }
	...
	if (filtro == 'pendiente') {
		$(function () {
		    $('#tPacientesDerivadosTens').DataTable({
		      ...
		      "stateSave": true,
		      "ajax": {
		                 "url": "2.0/vistas/serverProcessing/tens/pendientes.php",
		                 data: function (d) {
		                     d.idUsuario = $('#idUsuario').val();//paso el id del usuario para filtrar por sesion en el serverSide de datatable
		                 },
		             },
	...
	if (filtro == 'aceptada') {
		$(function () {
		    $('#tPacientesDerivadosTens').DataTable({
		      ...
		      "stateSave": true,
		      "ajax": {
		                 "url": "2.0/vistas/serverProcessing/tens/aceptadas.php",
		                 data: function (d) {
		                     d.idUsuario = $('#idUsuario').val();//paso el id del usuario para filtrar por sesion en el serverSide de datatable
		                 },
		             },
	...
	if (filtro == 'porVencer') {
		$(function () {
		    $('#tPacientesDerivadosTens').DataTable({
		      ...
		      "stateSave": true,
		      "ajax": {
		                 "url": "2.0/vistas/serverProcessing/tens/por_vencer.php",
		                 data: function (d) {
		                     d.idUsuario = $('#idUsuario').val();//paso el id del usuario para filtrar por sesion en el serverSide de datatable
		                 },
		             },
	...
	if (filtro == 'vencidas') {
		$(function () {
		    $('#tPacientesDerivadosTens').DataTable({
		      ...
		      "stateSave": true,
		      "ajax": {
		                 "url": "2.0/vistas/serverProcessing/tens/vencidas.php",
		                 data: function (d) {
		                     d.idUsuario = $('#idUsuario').val();//paso el id del usuario para filtrar por sesion en el serverSide de datatable
		                 },
		             },
	...
	if (filtro == 'cumplidas') {
		$(function () {
		    $('#tPacientesDerivadosTens').DataTable({
		      ...
		      "stateSave": true,
		      "ajax": {
		                 "url": "2.0/vistas/serverProcessing/tens/cumplidas.php",
		                 data: function (d) {
		                     d.idUsuario = $('#idUsuario').val();//paso el id del usuario para filtrar por sesion en el serverSide de datatable
		                 },
		             },
	...
	if (filtro == 'mas24HrsSinAgenda') {
		$(function () {
		    $('#tPacientesDerivadosTens').DataTable({
		      ...
		      "stateSave": true,
		      "ajax": {
		                 "url": "2.0/vistas/serverProcessing/tens/mas24HrsSinAgenda.php",
		                 data: function (d) {
		                     d.idUsuario = $('#idUsuario').val();//paso el id del usuario para filtrar por sesion en el serverSide de datatable
		                 },
		             },
	...
	if (filtro == 'mas10DiasSinAtencion') {
		$(function () {
		    $('#tPacientesDerivadosTens').DataTable({
		      ...
		      "stateSave": true,
		      "ajax": {
		                 "url": "2.0/vistas/serverProcessing/tens/mas10DiasSinAtencion.php",
		                 data: function (d) {
		                     d.idUsuario = $('#idUsuario').val();//paso el id del usuario para filtrar por sesion en el serverSide de datatable
		                 },
		             },
	...
	if (filtro == 'quirurgicas') {
		$(function () {
		    $('#tPacientesDerivadosTens').DataTable({
		      ...
		      "stateSave": true,
		      "ajax": {
		                 "url": "2.0/vistas/serverProcessing/tens/quirurgicas.php",
		                 data: function (d) {
		                     d.idUsuario = $('#idUsuario').val();//paso el id del usuario para filtrar por sesion en el serverSide de datatable
		                 },
		             },
	...
	if (filtro == 'Alta Paciente') {
		$(function () {
		    $('#tPacientesDerivadosTens').DataTable({
		      ...
		      "stateSave": true,
		      "ajax": {
		                 "url": "2.0/vistas/serverProcessing/tens/altaPaciente.php",
		                 data: function (d) {
		                     d.idUsuario = $('#idUsuario').val();//paso el id del usuario para filtrar por sesion en el serverSide de datatable
		                 },
		             },
	...
	if (filtro == 'Autorizado para pago') {
		$(function () {
		    $('#tPacientesDerivadosTens').DataTable({
		      ...
		      "stateSave": true,
		      "ajax": {
		                 "url": "2.0/vistas/serverProcessing/tens/autorizadoPago.php",
		                 data: function (d) {
		                     d.idUsuario = $('#idUsuario').val();//paso el id del usuario para filtrar por sesion en el serverSide de datatable
		                 },
		             },
	...
	if (filtro == 'Validado para Pago') {
		$(function () {
		    $('#tPacientesDerivadosTens').DataTable({
		      ...
		      "stateSave": true,
		      "ajax": {
		                 "url": "2.0/vistas/serverProcessing/tens/validadoPago.php",
		                 data: function (d) {
		                     d.idUsuario = $('#idUsuario').val();//paso el id del usuario para filtrar por sesion en el serverSide de datatable
		                 },
		             },
	...
	if (filtro == 'para_cierre') {
		$(function () {
		    $('#tPacientesDerivadosTens').DataTable({
		      ...
		      "ajax": {
		                 "url": "2.0/vistas/serverProcessing/tens/paraCierre.php",
		                 data: function (d) {
		                     d.idUsuario = $('#idUsuario').val();//paso el id del usuario para filtrar por sesion en el serverSide de datatable
		                 },
		             },
	...
	if (filtro == 'solicita_autorizacion') {
		$(function () {
		    $('#tPacientesDerivadosTens').DataTable({
		      ...
		      "lengthMenu": [[10, 50, -1], [10, 50, "Todos"]],
		      "ajax": {
		                 "url": "2.0/vistas/serverProcessing/tens/solicitaAutorizacion.php",
		                 data: function (d) {
		                     d.idUsuario = $('#idUsuario').val();//paso el id del usuario para filtrar por sesion en el serverSide de datatable
		                 },
		             },
	...
	if (filtro == 'solicita_autorizacion_en_plazo') {
		$(function () {
		    $('#tPacientesDerivadosTens').DataTable({
		      ...
		      "lengthMenu": [[10, 50, -1], [10, 50, "Todos"]],
		      "ajax": {
		                 "url": "2.0/vistas/serverProcessing/tens/solicitaAutorizacionEnPlazo.php",
		                 data: function (d) {
		                     d.idUsuario = $('#idUsuario').val();//paso el id del usuario para filtrar por sesion en el serverSide de datatable
		                 },
		             },
		...
		$(function () {
		    $('#tPacientesDerivadosTens').DataTable({
		      ...
		      "lengthMenu": [[10, 50, -1], [10, 50, "Todos"]],
		      "ajax": {
		                 "url": "2.0/vistas/serverProcessing/tens/solicitaAutorizacionRetrasada.php",
		                 data: function (d) {
		                     d.idUsuario = $('#idUsuario').val();//paso el id del usuario para filtrar por sesion en el serverSide de datatable
		                 },
		             },
	...
	if (filtro == 'prestador_asignado') {
		$(function () {
		    $('#tPacientesDerivadosTens').DataTable({
		      ...
		      "lengthMenu": [[10, 50, -1], [10, 50, "Todos"]],
		      "ajax": {
		                 "url": "2.0/vistas/serverProcessing/tens/prestadorAsignado.php",
		                 data: function (d) {
		                     d.idUsuario = $('#idUsuario').val();//paso el id del usuario para filtrar por sesion en el serverSide de datatable
		                 },
		             },
	...
	if (filtro == 'mis_casos') {
		$(function () {
		    $('#tPacientesDerivadosTens').DataTable({
		      ...
		      "lengthMenu": [[10, 50, -1], [10, 50, "Todos"]],
		      "ajax": {
		                 "url": "2.0/vistas/serverProcessing/tens/misCasos.php",
		                 data: function (d) {
		                     d.idUsuario = $('#idUsuario').val();//paso el id del usuario para filtrar por sesion en el serverSide de datatable
		                 },
		             },
