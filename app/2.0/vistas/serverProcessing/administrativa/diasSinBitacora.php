...
$usuario = $qrTipoUsuario->Fields('USUARIO');
...
$table = '';
    ...
    (
        ...
        WHERE NOT EXISTS (
            SELECT 1
            FROM 2_bitacora b
            WHERE b.ID_DERIVACION = a.ID_DERIVACION
            AND b.ASUNTO IN ('Bono', 'Información', 'Solicita gestión', 'Solicita Información', 'Llamada')
            AND b.AUDITORIA >= DATE_SUB(CURDATE(), INTERVAL 10 DAY) 
           
        )
        AND a.ESTADO_RN != 'Anulado' AND a.ESTADO_RN != 'Alta Paciente' AND a.ESTADO_RN != 'Finalizar prestacion con el prestador'
