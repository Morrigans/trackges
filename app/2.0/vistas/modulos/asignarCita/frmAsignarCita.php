...
$query_qrBuscaCita = "SELECT * FROM $MM_oirs_DATABASE.2_events WHERE ID_DERIVACION = '$idDerivacion' AND ESTADO_CITA='CITA' ";
...
$query_qrBuscaMaxi = "SELECT id FROM $MM_oirs_DATABASE.2_events WHERE ID_DERIVACION = '$idDerivacion' AND ESTADO_CITA ='ATENDIDO'";
        ...
        <div class="card-body">
        	...
        	<div class="row">
	        	...
	        	<div class="col-md-6"><h2>Agendamiento de citas:</h2></div>
						...
						<div class="col-md-6" id="dvInfoVentanasOpcionesAsignarCita"></div>	
	  		...
	  		<input type="hidden" id="idDerivacionAsignarCita" value="<?php echo $idDerivacion ?>">
...
<script>
idDerivacion = $('#idDerivacionAsignarCita').val();	
$('#dvInfoVentanasOpcionesAsignarCita').load('2.0/vistas/modulos/infoVentanasOpciones.php?idDerivacion='+idDerivacion);
	...
	if(trBuscaCita>0){
		...
		$.ajax({
      type: "POST",
      url: "2.0/vistas/modulos/asignarCita/buscaCitaAgendada.php",
      data: cadena,
      dataType:"json",
      success:function(r){
...
function fnGuardaAgendamientoCita(idDerivacion, tipoUsuario){
  ...
  if(fechaAgendamiento =='' || tipoAtencion ==''){
		...
		Swal.fire({
		  ...
		  $.ajax({
		    type: "POST",
		    url: "2.0/vistas/modulos/asignarCita/asignarCita.php",
		    data: cadena,
		    success:function(r){
...
if (obsQuitarCita=='') {
    ...
    $.ajax({
        type:"post",
        data:cadena,
        url:'2.0/vistas/modulos/asignarCita/quitaCitaAgendada.php',
        success:function(r){
            if (r == 1) {
                 Swal.fire({
		            position: 'top-end',
