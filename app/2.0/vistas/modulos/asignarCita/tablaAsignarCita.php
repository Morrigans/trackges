...
<script>
    function fnDesasociarTeamGestion(id,idDerivacion,rutPro) {
        ...
        $.ajax({
            type: "POST",
            url: "2.0/vistas/inicio/inicioSupervisora/modals/asignarTeamGestion/desasociarTeamGestion.php",
            data: cadena,
            success: function(r) {
                if (r == 1) {
                    $("#dvTablaTeamGestion").load('2.0/vistas/inicio/inicioSupervisora/modals/asignarTeamGestion/tablaTeamGestion.php?idDerivacion='+idDerivacion);
