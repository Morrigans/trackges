...
$comentarioBitacora = 'Segunda consulta del Folio'.$folio.'.<br/>Atiende paciente: '.$slAtiendePaciente.'. <br/>Quirúrgico: '.$slQuirurgico.'.<br/>Comentario atención: '.$slComentarioAtiendePaciente;
