...
$insertSQL = sprintf("INSERT INTO $MM_oirs_DATABASE.2_atenciones (ID_DERIVACION, ID_CITACION, ATENDIDO, CORRESPONDE, COMENTARIO, FECHA_REGISTRO, HORA_REGISTRO, RUTA_DOCUMENTO) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
...
$comentarioBitacora = 'Primera consulta del Folio'.$folio.'.<br/>Atiende paciente: '.$slAtiendePaciente.'. <br/>Comentario atención: '.$slComentarioAtiendePaciente;
