...
$updateSQL = sprintf("UPDATE $MM_oirs_DATABASE.derivaciones_canastas SET RUT_PRESTADOR=%s WHERE ID_CANASTA_PATOLOGIA = '$idDerivacionCanasta'",
...
$comentarioBitacora = 'Se cambia prestador ['.$qrPrestadores->Fields('DESC_PRESTADOR').'] a canasta ['.$descCanastaPatologia.'] de Etapa ['.$descEtapaPatologia.'] de la derivación número '.$nderivacion;
