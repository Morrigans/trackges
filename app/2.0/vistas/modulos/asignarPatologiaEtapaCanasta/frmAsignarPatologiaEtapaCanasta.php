...
<script>
	...
	function fnFiltraEtapasPatologias(){
	    ...
	    $("#slPatologiaDerivacion option:selected").each(function () {        
	        ...
	        if (tipoPatologia == '2') {
	          ...
	          $.post("2.0/vistas/derivacion/php/filtraEtapasPatologias.php",
	...
	function fnFiltraCanastasPatologias(){
      $("#slEtapaPatologiaDerivacion option:selected").each(function () {
          ...
          decreto = $("#decreto").val();
          $.post("2.0/vistas/derivacion/php/filtraCanastasPatologias.php",
    ...
    cadena = 'canasta='+ canasta;
      ...
      $.ajax({
       url: '2.0/vistas/derivacion/php/extraeTiempoLimite.php',
       type: "POST",
       data: cadena,
       success: function(r) {
...
function fnAsignarPatologiaEtapaCanasta(idDerivacion, tipoUsuario){
	...
	cadena = 'idDerivacion=' + idDerivacion +
		...
		$.ajax({
			type:"post",
			data:cadena,
			url:'2.0/vistas/modulos/asignarPatologiaEtapaCanasta/asignarPatologiaEtapaCanasta.php',
			success:function(r){
				if (r == 1) {
					Swal.fire({
					  position: 'top-end',
