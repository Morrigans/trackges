...
$query_qrBuscaAlarmas = "SELECT * FROM $MM_oirs_DATABASE.2_alarmas WHERE ID_ALARMA = '$idAlarma' ";
...
$updateSQL = sprintf("UPDATE $MM_oirs_DATABASE.2_alarmas SET CUMPLIDA=%s WHERE ID_ALARMA= '$idAlarma'",
...
$mensaje = 'La solicitud: '.$mensajeAlarma.',  asignada a: '.$nomFunc.', Rut '.$rutReceptor.', ha sido marcada como resuelta.';
date_default_timezone_set('America/Santiago');
$fecha= date('Y-m-d');
$hora= date('G:i');
