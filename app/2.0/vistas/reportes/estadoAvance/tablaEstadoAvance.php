...
<table id="tPacientesEstAv" class="table table-bordered table-striped table-hover table-sm">
	...
	if (filtro == 'todo') { 
		$(function () {
		    $('#tPacientesEstAv').DataTable({
		      ...
		      "ajax": {
		                 "url": "2.0/vistas/serverProcessing/estadoAvance.php",
		                 data: function (d) {
