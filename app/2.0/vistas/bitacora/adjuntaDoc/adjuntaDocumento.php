...
var myDropzone = new Dropzone(document.body, {
    url: "2.0/vistas/bitacora/adjuntaDoc/sube.php?idBitacora="+<?php echo $idBitacora?>,
    paramName: "file",
...
myDropzone.on("queuecomplete", function(progress) {
    ...
    setTimeout(function(){
        ...
        $('#dvTablaBitacora').load('2.0/vistas/bitacora/modals/tablaBitacora.php?idDerivacion=' +<?php echo $idDerivacion?>);
        $('#dvfrmDetalleDerivacion').load('2.0/vistas/inicio/inicioSupervisora/modals/derivacion/frmDetalleDerivacion.php?idDerivacion=' +<?php echo $idDerivacion?>);
        $('#dvfrmDetalleDerivacionGestora').load('2.0/vistas/inicio/inicioGestora/modals/derivacion/frmDetalleDerivacion.php?idDerivacion=' +<?php echo $idDerivacion?>);
    }, 2000);
    //fnCargarMiContenido('2.0/vistas/bitacora/adjuntaDoc/docs/tblMuestraMisPagosPendientes.php','content-wrapper');
