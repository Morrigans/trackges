...
var myDropzone = new Dropzone(document.body, {
    url: "2.0/vistas/bitacora/adjuntaDoc/subeDocAtencionPaciente.php?idDerivacion="+<?php echo $idDerivacion?>,
    paramName: "file",
...
myDropzone.on("success", function(file, response) {
	...
	$("#hdRutaAdjuntaDocAtencion").val(response);
});
...
myDropzone.on("queuecomplete", function(progress) {
    ...
    myDropzone.destroy();
    $("#dvCargaAdjuntarAtiendePaciente").hide();
    $("#dvMuestraBtnAdjuntarDoc").hide();
    $("#dvMuestraPreDocAdjunto").show();
