...
$query_qrAlarmas = ("SELECT * FROM $MM_oirs_DATABASE.2_alarmas where ID_BITACORA = '$idBitacora' AND ESTADO = 'activa'"); 
...
<script>
    function fnQuitarAlarmaProgramada(idAlarma,idBitacora) {
        ...
        $.ajax({
            type: "POST",
            url: "2.0/vistas/bitacora/modals/quitarAlarmaProgramada.php",
            data: cadena,
            success: function(r) {
                if (r == 1) {
