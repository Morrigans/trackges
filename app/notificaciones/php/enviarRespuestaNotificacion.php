...
$query_qrDerivacion = "SELECT * FROM $MM_oirs_DATABASE.notificaciones WHERE ID = '$id'";
...
$estadoNoti = 'nuevo';
 ...
 $insertSQL2 = sprintf("INSERT INTO $MM_oirs_DATABASE.notificaciones (ID_DERIVACION, ID_RESPUESTA, USUARIO, ASUNTO, MENSAJE, FECHA, HORA, ESTADO, USUARIO_EMISOR, ID_BITACORA) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
 ...
 $query_qrIdUltNoti = ("SELECT max(ID) as ID_NOTIFICACION FROM $MM_oirs_DATABASE.notificaciones");
...
$updateSQL = sprintf("UPDATE $MM_oirs_DATABASE.notificaciones SET ID_RESPUESTA=%s WHERE ID= '$id'",
