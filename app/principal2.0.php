...
require_once 'includes/functions.inc.php';
  ...
  require_once('2.0/notificaciones/modals/modalMensajeRecibido.php');
  require_once('2.0/notificaciones/modals/modalMensajeRecibidoIcrs.php');
  require_once('2.0/notificaciones/modals/modalVerTodoMensajes.php');
  require_once('2.0/notificaciones/modals/modalVerTodoMensajesIcrs.php');
  require_once('2.0/vistas/bitacora/modals/modalBitacora.php');
  // require_once('vistas/modulos/pacientesPp/bitacora/modals/modalBitacora.php');
  require_once('2.0/vistas/bitacora/modals/modalProgramarTarea.php');
  // require_once('2.0/vistas/bitacora/modals/modalPlayAudios.php');
  require_once('2.0/vistas/alarmas/modals/modalAlarmasInicio.php');
  ...
  // require_once('2.0/vistas/modulos/contactarPaciente/modalContactarPaciente.php');
  // require_once('2.0/vistas/bitacora/modals/modalAudios.php');
...
$query_qrBuscaAlarmas = "SELECT * FROM $MM_oirs_DATABASE.2_alarmas WHERE ESTADO = 'activa' AND FECHA_ALARMA <= '$hoy' AND USUARIO_RECEPTOR = '$usuario'";
...
<script>
  ...
  if (alarmas > 0) {
    ...
    $('#dvFrmAlarmasInicio').load('2.0/vistas/alarmas/modals/frmAlarmasInicio.php');
  }
  ...
  $("#menuSuperior").load('2.0/notificaciones/navbar.php');// carga menu superior la primera vez, en menu superior manejo notificaciones

  setInterval(function(){
    $("#menuSuperior").load('2.0/notificaciones/navbar.php');// carga menu superior cada x segundos, en menu superior manejo notificaciones
  }, 600000);
  ...
  if (tipoUsuario == 'Administrador') {
     if (origenMenu == 'icrs') {
        ...
        $('#contenido_principal').load('2.0/vistas/inicio/inicioSupervisora/inicioSupervisora.php'); //pagina que se carga al iniciar sesion o recargar la pagina
     } 
    ...
    $('#dvMenuReportes').load('2.0/vistas/menuLateral/menuReportes.php'); // menu que contiene submenus con mantenedores
    $('#dvMenuDash').load('2.0/vistas/menuLateral/menuDash.php'); // menu que contiene submenus con mantenedores
    $('#dvMenuDashboard').load('2.0/vistas/menuLateral/menuDashboardRn2.php'); // menu que contiene submenus con mantenedores
    $('#dvMenuEstadoAvance').load('vistas/menuLateral/menuEstadoAvance.php');
  ...
  if (tipoUsuario == 'Gestor') {
    ...
    // $('#dvMenuPp').load('vistas/menuLateral/menuPrimerPrestador.php');//menu  bandeja instituto  del  cancer
    $('#dvMenuReportes').load('2.0/vistas/menuLateral/menuReportes.php'); // menu que contiene submenus con reportes
    $('#dvMenuDash').load('2.0/vistas/menuLateral/menuDash.php'); // menu que contiene submenus con mantenedores
    $('#dvMenuDashboard').load('2.0/vistas/menuLateral/menuDashboardRn2.php'); // menu que contiene submenus con mantenedores
    $('#dvMenuEstadoAvance').load('vistas/menuLateral/menuEstadoAvance.php');
  }
  ...
  if (tipoUsuario == 'Administrativa') {
     if (origenMenu == 'icrs') {
        ...
        $('#contenido_principal').load('2.0/vistas/inicio/inicioAdministrativa/inicioAdministrativa.php'); //pagina que se carga al iniciar sesion o recargar la pagina
  ...
  if (tipoUsuario == 'Tens') {
     if (origenMenu == 'icrs') {
        ...
        $('#contenido_principal').load('2.0/vistas/inicio/inicioTens/inicioTens.php'); //pagina que se carga al iniciar sesion o recargar la pagina
     }
    // $('#dvMenuPp').load('vistas/menuLateral/menuPrimerPrestador.php');//menu  bandeja instituto  del  cancer
    $('#dvMenuDash').load('2.0/vistas/menuLateral/menuDash.php'); // menu que contiene submenus con mantenedores
     $('#dvMenuEstadoAvance').load('vistas/menuLateral/menuEstadoAvance.php');
